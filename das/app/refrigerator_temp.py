...
def process_fridge_temperature(
    df_sensor, is_door_open_fridge, anomaly_prompts, related_sensor, anomaly_sensors
):
    """
...
def record_anomaly(message, sensor, anomaly_prompts, related_sensor, anomaly_sensors):
    """
    감지한 이상치를 저장하는 함수입니다.
    """
